export const INITIAL_TASKS = [
  { id: 1,  title: "Redesign da tela de login",         priority: "urgent", assignee: "Ana S.",   assigneeInitials: "AS", due: "2026-06-10", subtasks: { done: 2, total: 5 }, status: "doing",   tags: ["Design"] },
  { id: 2,  title: "Integração com API de pagamento",   priority: "medium", assignee: "Lucas M.", assigneeInitials: "LM", due: "2026-06-18", subtasks: { done: 4, total: 4 }, status: "review",  tags: ["Dev", "API"] },
  { id: 3,  title: "Documentar fluxo de onboarding",    priority: "low",    assignee: "Carla T.", assigneeInitials: "CT", due: "2026-06-25", subtasks: { done: 0, total: 3 }, status: "backlog", tags: ["Docs"] },
  { id: 4,  title: "Testes de usabilidade",             priority: "medium", assignee: "João P.",  assigneeInitials: "JP", due: "2026-06-05", subtasks: { done: 1, total: 2 }, status: "done",    tags: ["UX"] },
  { id: 5,  title: "Configurar CI/CD no GitHub Actions",priority: "urgent", assignee: "Lucas M.", assigneeInitials: "LM", due: "2026-05-28", subtasks: { done: 1, total: 4 }, status: "doing",   tags: ["Dev", "Infra"] },
  { id: 6,  title: "Criar componente de DatePicker",    priority: "low",    assignee: "Ana S.",   assigneeInitials: "AS", due: "2026-07-01", subtasks: { done: 0, total: 2 }, status: "backlog", tags: ["Design", "Dev"] },
  { id: 7,  title: "Análise de métricas — Sprint 4",   priority: "medium", assignee: "Carla T.", assigneeInitials: "CT", due: "2026-06-12", subtasks: { done: 3, total: 3 }, status: "review",  tags: ["Analytics"] },
  { id: 8,  title: "Atualizar dependências do projeto", priority: "low",    assignee: "João P.",  assigneeInitials: "JP", due: "2026-06-30", subtasks: { done: 0, total: 1 }, status: "backlog", tags: ["Manutenção"] },
];
...
export const INITIAL_TICKETS = [
  ...
  { id: 3, type: "sugestao", title: "Adicionar filtro por data no Kanban", description: "Seria útil poder filtrar as tarefas por período de prazo.", authorId: "u4", author: "João P.", authorInitials: "JP", taskId: null, taskTitle: null, status: "aberto", priority: "normal", createdAt: "2026-06-06T09:00:00", responses: [] },
];
